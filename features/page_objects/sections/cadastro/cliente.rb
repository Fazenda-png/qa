  ...
  module Cadastro
    class Cliente < SitePrism::Section
      ...
      def uniaoCadastro1
        ...
        btn_salvar.gclick
        post = HTTParty.post('https://api-desafio.vercel.app/api/cliente',:headers => {'cache-control': 'public, max-age=0, must-revalidate','content-type': 'application/json'}, :body => {nome: "Zé Pinguço", cpf: "", nascimento: "", email: "", celular: "999999999", cep: "", logradouro: "", numero: "", bairro: "", cidade: "", pais: ""}.to_json)
      end
      ...
      def uniaoCadastro2
        ...
        btn_salvar.gclick
        post = HTTParty.post('https://api-desafio.vercel.app/api/cliente',:headers => {'cache-control': 'public, max-age=0, must-revalidate','content-type': 'application/json'}, :body => {nome: "Zé Pinguço", cpf: "", nascimento: "", email: "teste@teste.com", celular: "", cep: "", logradouro: "", numero: "", bairro: "", cidade: "", pais: ""}.to_json)
      end
